...
const LoadingIcon = ({ loading, color, width, height }) => {
  ...
  const xml = `<svg xmlns="http://www.w3.org/2000/svg" fill="${color}" width="800px" height="800px" viewBox="0 0 32 32" version="1.1">
  ...
  return (
    <Animated.View
      ...
      <SvgXml width={width || 25} height={height || 25} xml={xml} />
    </Animated.View>
  );
};
